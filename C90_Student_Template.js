...
function car1_up()
{
	...
	{
		car1_y = car1_y - 10;
		console.log("When up arrow is presseed, x = " + car1_x + " | y = " + car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_down()
{
	...
	{
		car1_y = car1_y + 10;
		console.log("When down arrow is presseed, x = " + car1_x + " | y = " + car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1_x = car1_x - 10;
		console.log("When left arrow is presseed, x = " + car1_x + " | y = " + car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1_x = car1_x + 10;
		console.log("When right arrow is presseed, x = " + car1_x + " | y = " + car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
	...
	function car2_down()
	{
		...
		{
			car2_y = car2_y + 10;
			console.log("When down arrow is presseed, x = " + car2_x + " | y = " + car2_y);
			uploadBackground();
			uploadcar1();
			uploadcar2();
		}
	...
	function car2_left()
	{
		...
		{
			car2_x = car2_x - 10;
			console.log("When left arrow is presseed, x = " + car2_x + " | y = " + car2_y);
			uploadBackground();
			uploadcar1();
			uploadcar2();
		}
	...
	function car2_right()
	{
		...
		{
			car2_x = car2_x + 10;
			console.log("When right arrow is presseed, x = " + car2_x + " | y = " + car2_y);
			uploadBackground();
			uploadcar1();
			uploadcar2();
		}
